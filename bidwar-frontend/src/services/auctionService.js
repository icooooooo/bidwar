...
const mockAuctionsData = [
  { auction_id: '1', title: 'Montre Vintage de Collection Extraordinaire', description: "Une superbe montre des années 60, en parfait état de marche. Un must-have pour les collectionneurs.", current_price: 150.00, prix_depart: 50.00, end_time: new Date(Date.now() + 3600000 * 2).toISOString(), status: 'Active', photos: [{image_url: 'https://images.unsplash.com/photo-1523275335684-37898b6baf30?ixlib=rb-1.2.1&auto=format&fit=crop&w=800&q=80'}, {image_url: 'https://images.unsplash.com/photo-1524805444758-089113d48a6d?ixlib=rb-1.2.1&auto=format&fit=crop&w=800&q=80'}], seller_id: '2', highest_bidder_id: 'temp2', bids: [{user_id: 'temp1', username: 'BidderOne', amount: 100, timestamp: new Date(Date.now() - 3600000 * 0.5).toISOString()}, {user_id: 'temp2', username: 'BidderTwo', amount: 150, timestamp: new Date(Date.now() - 3600000 * 0.2).toISOString()}] },
  { auction_id: '2', title: 'Tableau Ancien Signé - Huile sur Toile', description: "Oeuvre d'un artiste méconnu du 19ème siècle. Paysage bucolique. Cadre d'origine.", current_price: 320.00, prix_depart: 100.00, end_time: new Date(Date.now() + 3600000 * 5).toISOString(), status: 'Active', photos: [{image_url: 'https://images.unsplash.com/photo-1547891654-e66ed7ebb968?ixlib=rb-1.2.1&auto=format&fit=crop&w=800&q=80'}], seller_id: '2', highest_bidder_id: null, bids: [] },
  { auction_id: '3', title: 'Série de Pièces de Monnaie Rares', description: "Collection de pièces de monnaie de différents pays et époques. Certaines très rares.", current_price: 75.00, prix_depart: 20.00, end_time: new Date(Date.now() - 3600000 * 1).toISOString(), status: 'Ended', photos: [{image_url: 'https://images.unsplash.com/photo-1580130379629-3e90753960a6?ixlib=rb-1.2.1&auto=format&fit=crop&w=800&q=80'}], seller_id: '1', highest_bidder_id: 'temp_winner', bids: [] },
];
    ...
    return new Promise((resolve, reject) => {
        ...
        setTimeout(() => {
            const newAuction = {
                ...
                current_price: auctionData.prix_depart,
                bids: [],
